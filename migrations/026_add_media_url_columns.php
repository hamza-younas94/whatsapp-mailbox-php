...
return [
    'up' => function() {
        ...
        if (!$schema->hasColumn('messages', 'media_url')) {
            ...
            echo "ℹ️  media_url column already exists\n";
        }
        ...
        if (!$schema->hasColumn('messages', 'media_mime_type')) {
            ...
            echo "ℹ️  media_mime_type column already exists\n";
        }
        ...
        if (!$schema->hasColumn('messages', 'media_caption')) {
            ...
            echo "ℹ️  media_caption column already exists\n";
        }
    },
    ...
    'down' => function() {
        ...
        echo "✅ Removed media columns from messages table\n";
    }
];
