...
import quickReplyEnhancedRoutes from '@routes/quick-replies-enhanced';
import tagRoutes from '@routes/tags';
import segmentRoutes from '@routes/segments';
import segmentEnhancedRoutes from '@routes/segments-enhanced';
import broadcastRoutes from '@routes/broadcasts';
import broadcastEnhancedRoutes from '@routes/broadcasts-enhanced';
...
export function createApp(): Express {
  ...
  app.use('/api/v1/quick-replies-enhanced', quickReplyEnhancedRoutes);
  app.use('/api/v1/media', mediaRoutes);
  app.use('/api/v1/tags', tagRoutes);
  app.use('/api/v1/segments', segmentRoutes);
  app.use('/api/v1/segments-enhanced', segmentEnhancedRoutes);
  app.use('/api/v1/broadcasts', broadcastRoutes);
  app.use('/api/v1/broadcasts-enhanced', broadcastEnhancedRoutes);
